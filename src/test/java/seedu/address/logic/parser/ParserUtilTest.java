...
public class ParserUtilTest {
    ...
    private static final String INVALID_COMPANY = "Company@Invalid";
    ...
    private static final String VALID_COMPANY = "Tech Solutions Inc.";
    ...
    @Test
    public void parseCompany_emptyString_throwsParseException() {
